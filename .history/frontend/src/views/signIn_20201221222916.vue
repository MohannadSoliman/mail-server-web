  ...
  <div id="sign-in" class="sign-in-page">
    <div id="sign-in-form-container">
      <div id="sign-in-form">
        ...
        <input id ="email" placeholder="Email" type="text" @keydown="Check()">
        <div class="alert" id="signIn-email-alert">enter correct email</div>
...
export default {
  ...
  methods:{
    ...
    Check(){
      ...
      var alert_text = document.getElementById("signIn-email-alert")
      var pattern = /^[^ ]+@[^ ]+\.[a-z]{2,3}$/;
      
      if(email == ""){
        alert_text.remove("alert")
      }else if(email.match(pattern)){
        alert_text.innerHTML = "valid"
      }
      else {
        alert_text.innerHTML = "invalid"
      }
    }
  }
}
